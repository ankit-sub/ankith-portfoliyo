        ...
        <div className="lg:w-1/2 relative z-10">
          <FloatingElement animationType="float" delay={300}>
            <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto">
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-primary-purple to-ocean-blue opacity-15 blur-2xl animate-pulse-subtle"></div>
              <img 
                src="/lovable-uploads/78ad2c99-e1de-4eed-b19a-04fb19e0bb47.png" 
                alt="Ankith K R" 
