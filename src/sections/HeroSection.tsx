        ...
        <div className="lg:w-1/2 relative z-10">
          <FloatingElement animationType="float" delay={300}>
            <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto">
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-primary-purple to-ocean-blue opacity-20 blur-2xl animate-pulse-subtle"></div>
              <img 
                src="/lovable-uploads/4bbf8074-46c8-407a-9e3b-c99ccad5b9e3.png" 
                alt="Ankith K R" 
